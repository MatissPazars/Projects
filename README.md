...
## Building an TC (Theoretical Computer), Project #2 in align with my Degree. 
> [!NOTE]
...
Please note that I will be slowly moving the contents of this repository to their own dedicated repositories for each project.
