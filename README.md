...
4. Elegoo battery (from the Elegoo Smart Car V2.0 kit)
5. 3 (one for each motor) LM2598 step-down converters
6. Potenciometers for controlling the motors.
7. Obviously also wires and a breadboard. 
