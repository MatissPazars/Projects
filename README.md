...
Parts and used:
*Elegoo Centauri Carbon 3D printer (with Elegoo Rapid PLA+ as the filament)
*Freenove ESP32 Wrover Cam (without an camera, the camera broke)
*3 Muizei 20kg*cm 180 degree digital servos
*Elegoo battery (from the Elegoo Smart Car V2.0 kit)
*3 (one for each motor) LM2598 step-down converters
*Potenciometers for controlling the motors.
* Obviously also wires and a breadboard. 
